...
export class DoctorRegistrationDTO {
    ...
    @ApiPropertyOptional({
        type: 'string',
        description: 'e.g. Cardiology, General Medicine',
    })
    specialization?: string;
...
export class CreateDoctorServiceDTO {
    ...
    @ApiProperty({
        type: 'number',
        description: 'Duration in hours (1, 2, or custom)',
        required: true,
        example: 1,
    })
...
export class UpdateDoctorServiceDTO extends PartialType(
...
export class CreateConsultationDTO {
    ...
    @ApiPropertyOptional({
        type: 'number',
        description: 'Service ID used for this consultation',
    })
    serviceId?: number;
    ...
    @ApiPropertyOptional({
        type: 'number',
        description: 'Patient user ID (optional)',
    })
    userId?: number;
    ...
    @ApiPropertyOptional({
        type: 'number',
        description: 'Custom requested duration in hours (e.g. 1 or 2)',
    })
...
export class UpdateConsultationDurationDTO {
    ...
    @ApiProperty({
        type: 'number',
        description: 'Duration spent in minutes',
        required: true,
        example: 30,
    })
    spentMinutes: number;
